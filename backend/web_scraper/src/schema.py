...
class Overview(BaseModel):
    ...
    founded_year: str | int | None = None
    headquarters: str | None = None
    employee_count: int | str | None = None
    linkedin_followers: int | str | None = None
    linkedin_members: int | str | None = None
    company_size: str | None = None
    global_offices: str | int | None = None
...
class LinkedInInsights(BaseModel):
    ...
    founded_year: str | int | None = None
    headquarters: str | None = None
    employee_count: str | int | None = None
    linkedin_followers: str | int | None = None
    linkedin_members: str | int | None = None
    company_size: str | None = None
    global_offices: str | int | None = None
    hiring_status: str | None = None
    description: str | None = None
    via: list[str] = Field(default_factory=lambda: ["linkedin"])
...
class SourcesStatus(BaseModel):
    ...
    linkedin_company: SourceStatus = Field(default_factory=SourceStatus)
...
class CompanyDossier(BaseModel):
    ...
    linkedin_insights: LinkedInInsights = Field(default_factory=LinkedInInsights)
